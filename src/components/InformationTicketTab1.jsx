    ...
    return (
        <div className="w-full space-y-16">
            ...
            <div className="w-full flex flex-col space-y-6">
                ...
                <div className=" space-y-2 px-6 text-neutral-700">
                    <p>- 대구오페라하우스 : daeguoperahouse.org</p>
                    <p>- 인터파크 : ticketpark.com</p>
                    <p>
                        - 대구오페라하우스 홈페이지를 통해서 예매하시면
                        예매수수료가 없습니다.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full flex flex-col space-y-6">
                ...
                <div className=" space-y-2 px-6 text-neutral-700">
                    <p>
                        - 공연 당일 수령 - 공연시작 1시간 30분 전부터 1층
                        매표소에서 수령
                    </p>
                    <p>
                        - 티켓 수령시 예매자명과 예매번호를 정확히 알고 오시면
                        티켓 수령이 좀 더 원활할 수 있습니다.
                    </p>
                    <p>
                        - 입장권 분실 및 파손 시 재발급이 되지 않으니 보관에
                        유의하여 주십시오.{" "}
                    </p>
                    <p>
                        - 현장매표소 운영은 공연 당일 본관 1층에서만 진행하며,
                        공연 시작 1시간 30분 전부터 공연시작 전까지 구입가능
                        합니다.
                    </p>
                </div>
            </div>
                ...
                <table className="table_top">
                    <tbody>
                        <tr>
                            <td
                                rowSpan={3}
                                className="table_td border-l-0 text-center"
                            >
                                기본할인
                            </td>
