...
export default function RentalNoticeWrite() {
    ...
    const table_class_input =
        "w-full text-sm border border-neutral-300 focus:border-neutral-400 focus:bg-neutral-100 placeholder:text-neutral-300";
    if (data?.ok === "true") {
        navigate("/rental");
    }
    return (
                            ...
                            <tr>
                                ...
                                <td className={`${table_class_td}`}>
                                    <input
                                        {...register("writer")}
                                        type="text"
                                        className="w-80 text-sm border border-neutral-300 focus:border-neutral-400 focus:bg-neutral-100 placeholder:text-neutral-300"
                                    />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td className={`${table_class_td}`}>
                                    <input
                                        {...register("title")}
                                        type="text"
                                        className="w-full text-sm border border-neutral-300 focus:border-neutral-400 focus:bg-neutral-200 placeholder:text-neutral-300"
                                    />
                                </td>
                            </tr>
                            <tr>
